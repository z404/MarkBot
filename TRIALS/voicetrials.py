...
class Client(discord.Client):
    def __init__(self, *args, **kwargs):
        ...
        self.connections = {
            voice.guild.id: voice for voice in self.voice_clients}
        self.playlists = {}
    ...
    # @vc_required
    async def play_recording(self, msg, vc=None):
        r = sr.Recognizer()
        with sr.AudioFile('589421.wav') as source:
        ...
        try:
            ...
            await msg.channel.send("Google Speech Recognition thinks you said " +
        ...
        # vc.play(discord.FFmpegPCMAudio('584538.wav'))
    ...
    async def start_recording(self, msg, vc):
        ...
        vc.start_recording(discord.Sink(
            encoding=encoding, filters=filters), self.finished_callback, msg.channel)
...
client.run('ODA4OTczMzMyOTg4OTUyNTg2.YCOVIA.MTPSZdIOzBYxIedsWgOm4-5bdc4')
